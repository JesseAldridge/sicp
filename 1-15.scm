...
; log(n) in time because we repeatedly divide the angle
; log(n) in space because we keep each call on the stack until we are below the threshold

(sine 12.15) ; called 5 times
(sine 10000) ; called 11 times
